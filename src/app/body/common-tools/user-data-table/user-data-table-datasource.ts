 ...
 */
export class UserDataTableDataSource extends DataSource<UserFetched> {
  public data: UserFetched[];
   ...
   */
  connect(): Observable<UserFetched[]> {
   ...
   */
  private getPagedData(data: UserFetched[]): UserFetched[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: UserFetched[]) {
