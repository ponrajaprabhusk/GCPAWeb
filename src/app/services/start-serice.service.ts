...
export class StartSericeService {
  ...
  constructor(private galleryService: GalleryDashboardService, private testimonialService: TestimonialsServiceService, private partnerService: PartnerServiceService, private newsService: NewsServiceService) { }
  StartApplication(){
